...
{
\lstset{ float=htbp }
\lstset{ language={#1}, label={l:#2}, caption={#2} }
}{}

\lstnewenvironment{ccode}[1]
{
\lstset{ float=htbp }
\lstset{ language={C}, label={l:#1}, caption={#1} }
}{}

\lstnewenvironment{asmcode}[1]
{
\lstset{ float=htbp }
\lstset{ language={sh}, label={l:#1}, caption={#1} }
}{}

\lstnewenvironment{stdout}[2]
{
\lstset{ float=htbp }
\lstset{ language={sh}, label={l:#1}, caption={#2} }
}{}
